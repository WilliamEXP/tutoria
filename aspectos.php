...
<div class="main">
    ...
    <h2>Aspectos fundamentales de operación</h2>
        ...
        <p>Uno de los elementos primordiales de este modelo es la necesidad de contar con diagnósticos institucionales y por programa educativo de las necesidades de los estudiantes. En la Figura 2 se puede observar el desarrollo del programa considerando tres momentos: inicio del semestre, desarrollo de las actividades y el momento de cierre o evaluación.</p>
        ...
        <p>Para la fase de evaluación, se incluye un momento para que los tutorados evalúen el desempeño de sus tutores, la evaluación de desarrollo de habilidades por parte de los tutores a los tutorados y se agregó una evaluación de los tutores por parte del comité de tutorías como un mecanismo para evaluar el estado de los grupos y poder hacer un diagnóstico general por programa educativo e institucional.</p>
