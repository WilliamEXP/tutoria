  ...
  <?php include('layout/template.php'); ?>
    <div class="main">
      <div class="text txt-justify">
        ...
        <p>
          El Comité de Tutorías es un cuerpo académico, integrado con la
          finalidad de favorecer la acción Tutorial en beneficio de los
          estudiantes.
        </p>

        <p>
          El Comité tiene dos sesiones obligatorias por semestre: una antes de
          iniciar el semestre y otra al concluir el semestre, mientras que la
          primera es de planeación. La segunda es de evaluación. Antes de
          iniciar un semestre escolar, el Comité sesiona con la finalidad de
          gestionar los recursos humanos para el desarrollo de programa,
          proponer los docentes que puedan fungir como Tutores de manera
          adecuada y decidir las cargas de Tutoría que tendrán los Tutores para
          ese ciclo semestral. Se buscará en lo posible mantener a un Tutor al
          menos un año con el grupo, siempre que su evaluación y sus resultados
          muestren que el desempeño de su función está contribuyendo con su
          desarrollo, en caso contrario, el Jefe de Carrera del Programa
          Educativo o el Coordinador del Programa Institucional de Tutoría,
          podrán proponer la sustitución respectiva. Al concluir el semestre, el
          Comité sesionará para conocer los resultados de los Tutores y el grado
          de cumplimiento expresado en la evidencia documental y la opinión de
