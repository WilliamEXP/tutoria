...
<body>
    ...
    <div class="main">
        <div class="text txt-justify">
            ...
            <h3>Descripción</h3>
            <p>El tutor explicará a los estudiantes cuáles son las características y la importancia de la participación en las actividades de formación integral en el el instituto.</p>
        ...
        <a href="s3-semana3.php" class="atras"><</a>
        <a href="s3-semana5.php " class="siguiente">></a>
    </div>
</body>
