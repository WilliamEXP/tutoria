...
<body>
    ...
    <div class="main">
        <div class="text txt-justify">
            ...
            <ol type ="1">
                <li>El Tutor presentará ante el grupo las actividades a
                    realizar durante el semestre como parte de su formación integral.</li>
        ...
        <a href="s5-semana16.php" class="atras"><</a>
        <a href="s6-semana2.php" class="siguiente">></a>
    </div>
</body>
